...
(0, config_1.task)('deploy:arbHardhat', 'Deploys Arbitrum forked chain contracts').setAction(async function (taskArguments, { ethers }) {
    ...
    const receiver = await RedemptionReceiver.deploy(ARB_CONFIG.USDC, flow.address, FTM_CONFIG.lzChainId, ARB_CONFIG.lzEndpoint);
    await receiver.deployed();
    console.log('RedemptionReceiver deployed to: ', receiver.address);
    console.log('Args: ', ARB_CONFIG.USDC, flow.address, FTM_CONFIG.lzChainId, ARB_CONFIG.lzEndpoint, '\n');
