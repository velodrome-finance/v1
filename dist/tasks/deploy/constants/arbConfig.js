...
console.log(MILLION)
const HALF_MILLION = ethers_1.ethers.BigNumber.from('.5')
  .mul(MILLION)
  .mul(TOKEN_DECIMALS) // not sure if we can do this??
...
const TEN_MILLION = ethers_1.ethers.BigNumber.from('10')
  .mul(MILLION)
  .mul(TOKEN_DECIMALS)
const TWELEVE_MILLION = ethers_1.ethers.BigNumber.from('12')
  .mul(MILLION)
  .mul(TOKEN_DECIMALS)
...
const SIXTY_MILLION = ethers_1.ethers.BigNumber.from('60')
  .mul(MILLION)
  .mul(TOKEN_DECIMALS)
const PARTNER_MAX = ethers_1.ethers.BigNumber.from('90') // It will literally mint this many  tokens so be careful with it..
  .mul(MILLION)
  .mul(TOKEN_DECIMALS)
...
const faeflow = '0x069e85D4F1010DD961897dC8C095FBB5FF297434'
