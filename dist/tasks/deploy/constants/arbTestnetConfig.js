...
const FOUR_MILLION = ethers_1.ethers.BigNumber.from('4').mul(MILLION).mul(TOKEN_DECIMALS);
const TEN_MILLION = ethers_1.ethers.BigNumber.from('10').mul(MILLION).mul(TOKEN_DECIMALS);
const TWENTY_MILLION = ethers_1.ethers.BigNumber.from('20')
    .mul(MILLION)
    .mul(TOKEN_DECIMALS);
const PARTNER_MAX = ethers_1.ethers.BigNumber.from('78').mul(MILLION).mul(TOKEN_DECIMALS);
...
exports.default = arbTestnetConfig;
