...
const arbTestnetConfig_1 = __importDefault(require("./constants/arbTestnetConfig"));
...
(0, config_1.task)('deploy:arb', 'Deploys Arbitrum contracts').setAction(async function (taskArguments, { ethers }) {
    const mainnet = true;
    const ARB_CONFIG = mainnet ? arbConfig_1.default : arbTestnetConfig_1.default;
